...
![FilaKit](https://raw.githubusercontent.com/jeffersongoncalves/filakit/main/art/jeffersongoncalves-filakit.png)
...
```bash
filakit new my-app --kit=jeffersongoncalves/filakit
```
